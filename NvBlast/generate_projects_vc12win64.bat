...
@echo.
@call "%~dp0buildtools\packman\windows\packman.cmd" %PM_OPTIONS_EXT% pull "%~dp0dependencies.xml" --platform vc12win64 --postscript "%~dp0buildtools\cmake_projects_vc12win64.bat"
@if %ERRORLEVEL% neq 0 (
    @exit /b %errorlevel%
) else (
    @echo Success!
