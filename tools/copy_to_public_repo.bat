...
robocopy %~dp0.. %dst% /s /ns /nc /ndl /np /xd "_*" ".*" "tools" "exporter" "physx" "RT" "apps" "samples" /xf "NvBlastExtPx*" "NvBlastExtKJPx*" "ExtPx*" "ext_px*" "ext_physx*" "ext_exporter*" "tinyobjloader-LICENSE.md"
