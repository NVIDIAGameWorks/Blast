...
if (PHYSXSDK_FOUND)
	...
	SET(PHYSXSDK_LIBS_RELEASE ${PHYSX3_LIB} ${PHYSX3EXTENSIONS_LIB} ${PHYSX3COMMON_LIB} ${PHYSX3COOKING_LIB} ${PHYSX3GPU_LIB} ${LOWLEVEL_LIB} ${LOWLEVELAABB_LIB} ${LOWLEVELCLOTH_LIB} ${LOWLEVELDYNAMICS_LIB} ${LOWLEVELPARTICLES_LIB} ${SCENEQUERY_LIB} ${SIMULATIONCONTROLLER_LIB}
		CACHE STRING ""
	)
	SET(PHYSXSDK_LIBS_DEBUG ${PHYSX3_LIB_DEBUG} ${PHYSX3EXTENSIONS_LIB_DEBUG} ${PHYSX3COMMON_LIB_DEBUG} ${PHYSX3COOKING_LIB_DEBUG} ${PHYSX3GPU_LIB_DEBUG} ${LOWLEVEL_LIB_DEBUG} ${LOWLEVELAABB_LIB_DEBUG} ${LOWLEVELCLOTH_LIB_DEBUG} ${LOWLEVELDYNAMICS_LIB_DEBUG} ${LOWLEVELPARTICLES_LIB_DEBUG} ${SCENEQUERY_LIB_DEBUG} ${SIMULATIONCONTROLLER_LIB_DEBUG}
		CACHE STRING ""
	)
	SET(PHYSXSDK_LIBS_CHECKED ${PHYSX3_LIB_CHECKED} ${PHYSX3EXTENSIONS_LIB_CHECKED} ${PHYSX3COMMON_LIB_CHECKED} ${PHYSX3COOKING_LIB_CHECKED} ${PHYSX3GPU_LIB_CHECKED} ${LOWLEVEL_LIB_CHECKED} ${LOWLEVELAABB_LIB_CHECKED} ${LOWLEVELCLOTH_LIB_CHECKED} ${LOWLEVELDYNAMICS_LIB_CHECKED} ${LOWLEVELPARTICLES_LIB_CHECKED} ${SCENEQUERY_LIB_CHECKED} ${SIMULATIONCONTROLLER_LIB_CHECKED}
		CACHE STRING ""
	)
	SET(PHYSXSDK_LIBS_PROFILE ${PHYSX3_LIB_PROFILE} ${PHYSX3EXTENSIONS_LIB_PROFILE} ${PHYSX3COMMON_LIB_PROFILE} ${PHYSX3COOKING_LIB_PROFILE} ${PHYSX3GPU_LIB_PROFILE} ${LOWLEVEL_LIB_PROFILE} ${LOWLEVELAABB_LIB_PROFILE} ${LOWLEVELCLOTH_LIB_PROFILE} ${LOWLEVELDYNAMICS_LIB_PROFILE} ${LOWLEVELPARTICLES_LIB_PROFILE} ${SCENEQUERY_LIB_PROFILE} ${SIMULATIONCONTROLLER_LIB_PROFILE}
		CACHE STRING ""
	)

	#NOTE: This is all dll configs, might need to be split.
	SET(PHYSXSDK_DLLS 
		$<$<CONFIG:debug>:${PHYSX3_DLL_DEBUG}>
		$<$<CONFIG:debug>:${PHYSX3COMMON_DLL_DEBUG}>
		$<$<CONFIG:debug>:${PHYSX3COOKING_DLL_DEBUG}>
		$<$<CONFIG:debug>:${PHYSX3GPU_DLL_DEBUG}>
		$<$<CONFIG:checked>:${PHYSX3_DLL_CHECKED}>
		$<$<CONFIG:checked>:${PHYSX3COMMON_DLL_CHECKED}>
		$<$<CONFIG:checked>:${PHYSX3COOKING_DLL_CHECKED}>
		$<$<CONFIG:checked>:${PHYSX3GPU_DLL_CHECKED}>
		$<$<CONFIG:profile>:${PHYSX3_DLL_PROFILE}>
		$<$<CONFIG:profile>:${PHYSX3COMMON_DLL_PROFILE}>
		$<$<CONFIG:profile>:${PHYSX3COOKING_DLL_PROFILE}>
		$<$<CONFIG:profile>:${PHYSX3GPU_DLL_PROFILE}>
		$<$<CONFIG:release>:${PHYSX3_DLL}>
		$<$<CONFIG:release>:${PHYSX3COMMON_DLL}>
		$<$<CONFIG:release>:${PHYSX3COOKING_DLL}>
		$<$<CONFIG:release>:${PHYSX3GPU_DLL}>
	)
