...
ARTIFACTS = [
	# source windows-like platforms
	{
		...
		'include' 	:
		{
			...
			'./tools/compiler/%tool%%platform%' 						: [".sln", ".vcxproj", ".filters", ".vsprops"],
			'./shared'							 						: ["*"],
			'./docs/source_docs'					 					: ["*"],
			'./docs/api_docs'					 						: ["*"],
		},
	...
	# SDK only for windows-like platforms
	{
		...
		'skipwithsubstr' 	:
		{
			'./bin/%tool%%platform%': ['AntTweakBar','APEX', 'Apex','Assimp32', 'PhysX', 'GFSDK', 'd3dcompiler_47', 'nvToolsExt', 'SDL2']
		},
	...
	# Tools and samples
	{
		...
		'./bin/%tool%%platform%/ApexImporter.exe',
	...
	# SDK only unix-like platforms
	{
		...
		'skipwithsubstr' 	:
		{
			'./bin/%tool%%platform%': ['AntTweakBar','APEX', 'Apex','Assimp32', 'PhysX', 'GFSDK_SSAO', 'd3dcompiler_47', 'nvToolsExt']
		},
