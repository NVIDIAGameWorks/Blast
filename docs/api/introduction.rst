...
Blast is currently designed to support rigid body, pre-fractured destruction.  Future versions may support runtime fracturing
or deformation.

The static data associated with a destructible is stored in an *asset*.  Assets are instanced into actors, which may
be damaged and fractured.  When fractured, actors are broken into pieces called *chunks*.  Connected groups of chunks
...
loss of bond and chunk health is determined by a user-defined *material function*.  In this way the user can customize the
...
healths are considered to be broken.  Blast performs island detection on the support graph to find all groups of support chunks
...
user to delete them, and manage their physical and graphical representation outside of Blast if so desired.
